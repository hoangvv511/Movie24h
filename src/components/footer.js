            ...
            <footer className="footer" style={{display:'auto'}}>
                <div className="container">
                    ...
                    <ul className="has-text-grey-light">
                        ...
                        <li>Vì trang web mới được lập ra nên còn nhiều phim chưa được up, chúng tôi đang xử lý 1 số lượng lớn phim &amp; sẽ up dần trong thời gian tới (xem <a href="/all-movies">tất cả phim</a>).</li>
                    </ul>
                    <div>
